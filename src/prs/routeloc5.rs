...
impl crate::ToBits<u8> for CH20LOC_A {
    #[inline(always)]
    fn _bits(&self) -> u8 {
        match *self {
            CH20LOC_A::LOC0 => 0,
...
impl<'a> CH20LOC_W<'a> {
    ...
    #[inline(always)]
    pub fn variant(self, variant: CH20LOC_A) -> &'a mut W {
        use crate::ToBits;
...
impl crate::ToBits<u8> for CH21LOC_A {
    #[inline(always)]
    fn _bits(&self) -> u8 {
        match *self {
            CH21LOC_A::LOC0 => 0,
...
impl<'a> CH21LOC_W<'a> {
    #[doc = r"Writes `variant` to the field"]
    #[inline(always)]
    pub fn variant(self, variant: CH21LOC_A) -> &'a mut W {
        use crate::ToBits;
        unsafe { self.bits(variant._bits()) }
    }
    #[doc = "Location 0"]
...
impl crate::ToBits<u8> for CH22LOC_A {
    #[inline(always)]
    fn _bits(&self) -> u8 {
        match *self {
            CH22LOC_A::LOC0 => 0,
...
impl<'a> CH22LOC_W<'a> {
    #[doc = r"Writes `variant` to the field"]
    #[inline(always)]
    pub fn variant(self, variant: CH22LOC_A) -> &'a mut W {
        use crate::ToBits;
        unsafe { self.bits(variant._bits()) }
    }
    #[doc = "Location 0"]
...
impl crate::ToBits<u8> for CH23LOC_A {
    #[inline(always)]
    fn _bits(&self) -> u8 {
        match *self {
            CH23LOC_A::LOC0 => 0,
...
impl<'a> CH23LOC_W<'a> {
    #[doc = r"Writes `variant` to the field"]
    #[inline(always)]
    pub fn variant(self, variant: CH23LOC_A) -> &'a mut W {
        use crate::ToBits;
        unsafe { self.bits(variant._bits()) }
    }
    #[doc = "Location 0"]
