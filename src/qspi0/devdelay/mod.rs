...
impl W {
    ...
    #[doc = "Bits 0:7 - Clock Delay for CS"]
    #[inline]
    pub fn dinit(&mut self) -> _DINITW {
        _DINITW { w: self }
    }
    #[doc = "Bits 8:15 - Clock Delay for Last Transaction Bit"]
    #[inline]
    pub fn dafter(&mut self) -> _DAFTERW {
        _DAFTERW { w: self }
    }
    #[doc = "Bits 16:23 - Clock Delay Between Two Chip Selects"]
    #[inline]
    pub fn dbtwn(&mut self) -> _DBTWNW {
        _DBTWNW { w: self }
    }
    #[doc = "Bits 24:31 - Clock Delay for Chip Select Deassert"]
    #[inline]
    pub fn dnss(&mut self) -> _DNSSW {
        _DNSSW { w: self }
    }
}
