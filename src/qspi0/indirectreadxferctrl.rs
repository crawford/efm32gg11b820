...
impl super::INDIRECTREADXFERCTRL {
...
#[doc = r" Proxy"]
pub struct _INDOPSDONESTATUSW<'a> {
    w: &'a mut W,
}
impl<'a> _INDOPSDONESTATUSW<'a> {
    #[doc = r" Sets the field bit"]
    pub fn set_bit(self) -> &'a mut W {
        self.bit(true)
    }
...
impl W {
    ...
    #[inline]
    pub fn cancel(&mut self) -> _CANCELW {
        _CANCELW { w: self }
    }
    #[doc = "Bit 3 - SRAM Full"]
    #[inline]
    pub fn sramfull(&mut self) -> _SRAMFULLW {
        _SRAMFULLW { w: self }
    }
    #[doc = "Bit 5 - Indirect Completion Status"]
    #[inline]
    pub fn indopsdonestatus(&mut self) -> _INDOPSDONESTATUSW {
        _INDOPSDONESTATUSW { w: self }
    }
}
