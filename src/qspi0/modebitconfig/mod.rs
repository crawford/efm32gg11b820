...
#[doc = r" Proxy"]
pub struct _CHUNKSIZEW<'a> {
    w: &'a mut W,
}
impl<'a> _CHUNKSIZEW<'a> {
    #[doc = r" Writes raw bits to the field"]
    #[inline]
    pub unsafe fn bits(self, value: u8) -> &'a mut W {
        const MASK: u8 = 7;
...
#[doc = r" Proxy"]
pub struct _CRCOUTENABLEW<'a> {
    w: &'a mut W,
}
impl<'a> _CRCOUTENABLEW<'a> {
...
impl W {
    ...
    #[doc = "Bits 8:10 - Chunk Size"]
    #[inline]
    pub fn chunksize(&mut self) -> _CHUNKSIZEW {
        _CHUNKSIZEW { w: self }
    }
    #[doc = "Bit 15 - CRC# Output Enable Bit"]
    #[inline]
    pub fn crcoutenable(&mut self) -> _CRCOUTENABLEW {
        _CRCOUTENABLEW { w: self }
    }
}
