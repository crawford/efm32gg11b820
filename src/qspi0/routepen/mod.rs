...
#[doc = r" Proxy"]
pub struct _SCLKINPENW<'a> {
    w: &'a mut W,
}
impl<'a> _SCLKINPENW<'a> {
    #[doc = r" Sets the field bit"]
    pub fn set_bit(self) -> &'a mut W {
        self.bit(true)
    }
...
impl W {
    ...
    #[doc = "Bit 0 - SCLK Pin Enable"]
    #[inline]
    pub fn sclkpen(&mut self) -> _SCLKPENW {
        _SCLKPENW { w: self }
    }
    #[doc = "Bit 1 - CS0 Pin Enable"]
    #[inline]
    ...
    #[doc = "Bit 5 - DQ0 Pin Enable"]
    #[inline]
    pub fn dq0pen(&mut self) -> _DQ0PENW {
        _DQ0PENW { w: self }
    }
    #[doc = "Bit 6 - DQ1 Pin Enable"]
    #[inline]
    pub fn dq1pen(&mut self) -> _DQ1PENW {
        _DQ1PENW { w: self }
    }
    #[doc = "Bit 7 - DQ2 Pin Enable"]
    #[inline]
    pub fn dq2pen(&mut self) -> _DQ2PENW {
        _DQ2PENW { w: self }
    }
    #[doc = "Bit 8 - DQ3 Pin Enable"]
    #[inline]
    pub fn dq3pen(&mut self) -> _DQ3PENW {
        _DQ3PENW { w: self }
    }
    #[doc = "Bit 9 - DQ4 Pin Enable"]
    #[inline]
    pub fn dq4pen(&mut self) -> _DQ4PENW {
        _DQ4PENW { w: self }
    }
    #[doc = "Bit 10 - DQ5 Pin Enable"]
    #[inline]
    pub fn dq5pen(&mut self) -> _DQ5PENW {
        _DQ5PENW { w: self }
    }
    #[doc = "Bit 11 - DQ6 Pin Enable"]
    #[inline]
    pub fn dq6pen(&mut self) -> _DQ6PENW {
        _DQ6PENW { w: self }
    }
    #[doc = "Bit 12 - DQ7 Pin Enable"]
    #[inline]
    pub fn dq7pen(&mut self) -> _DQ7PENW {
        _DQ7PENW { w: self }
    }
    #[doc = "Bit 13 - DQS Pin Enable"]
    #[inline]
    pub fn dqspen(&mut self) -> _DQSPENW {
        _DQSPENW { w: self }
    }
    #[doc = "Bit 14 - SCLKIN Pin Enable"]
    #[inline]
    pub fn sclkinpen(&mut self) -> _SCLKINPENW {
        _SCLKINPENW { w: self }
    }
}
