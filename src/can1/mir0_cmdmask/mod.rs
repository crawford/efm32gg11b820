...
#[doc = r" Proxy"]
pub struct _TXRQSTNEWDATW<'a> {
    w: &'a mut W,
}
impl<'a> _TXRQSTNEWDATW<'a> {
    #[doc = r" Sets the field bit"]
    pub fn set_bit(self) -> &'a mut W {
        self.bit(true)
    }
...
impl W {
    ...
    #[doc = "Bit 2 - Transmission Request Bit/ New Data Bit"]
    #[inline]
    pub fn txrqstnewdat(&mut self) -> _TXRQSTNEWDATW {
        _TXRQSTNEWDATW { w: self }
    }
    #[doc = "Bit 3 - Clear Interrupt Pending Bit"]
    #[inline]
    ...
    #[doc = "Bit 5 - Access Arbitration Bits"]
    #[inline]
    pub fn arbacc(&mut self) -> _ARBACCW {
        _ARBACCW { w: self }
    }
    #[doc = "Bit 6 - Access Mask Bits"]
    #[inline]
    pub fn maskacc(&mut self) -> _MASKACCW {
        _MASKACCW { w: self }
    }
    #[doc = "Bit 7 - Write/Read RAM"]
    #[inline]
    pub fn wrrd(&mut self) -> _WRRDW {
        _WRRDW { w: self }
    }
}
