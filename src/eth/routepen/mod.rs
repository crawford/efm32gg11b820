...
#[doc = r" Proxy"]
pub struct _MIITXERPENW<'a> {
    w: &'a mut W,
}
impl<'a> _MIITXERPENW<'a> {
    #[doc = r" Sets the field bit"]
    pub fn set_bit(self) -> &'a mut W {
        self.bit(true)
    }
...
#[doc = r" Proxy"]
pub struct _MIIRXERPENW<'a> {
    w: &'a mut W,
}
impl<'a> _MIIRXERPENW<'a> {
    #[doc = r" Sets the field bit"]
    pub fn set_bit(self) -> &'a mut W {
        self.bit(true)
    }
...
#[doc = r" Proxy"]
pub struct _TSUTMRTOGPENW<'a> {
    w: &'a mut W,
}
impl<'a> _TSUTMRTOGPENW<'a> {
    #[doc = r" Sets the field bit"]
    pub fn set_bit(self) -> &'a mut W {
        self.bit(true)
    }
...
impl W {
    ...
    #[doc = "Bit 0 - MDIO I/O Enable"]
    #[inline]
    pub fn mdiopen(&mut self) -> _MDIOPENW {
        _MDIOPENW { w: self }
    }
    #[doc = "Bit 1 - MII TX ER I/O Enable"]
    #[inline]
    pub fn miitxerpen(&mut self) -> _MIITXERPENW {
        _MIITXERPENW { w: self }
    }
    #[doc = "Bit 2 - MII TX ER I/O Enable"]
    #[inline]
    pub fn miirxerpen(&mut self) -> _MIIRXERPENW {
        _MIIRXERPENW { w: self }
    }
    #[doc = "Bit 3 - MII I/O Enable"]
    #[inline]
    pub fn miipen(&mut self) -> _MIIPENW {
        _MIIPENW { w: self }
    }
    #[doc = "Bit 4 - RMII I/O Enable"]
    #[inline]
