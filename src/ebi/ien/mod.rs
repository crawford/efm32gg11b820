...
#[doc = r" Proxy"]
pub struct _TFTPIXEL0EMPTYW<'a> {
    w: &'a mut W,
}
impl<'a> _TFTPIXEL0EMPTYW<'a> {
    #[doc = r" Sets the field bit"]
    pub fn set_bit(self) -> &'a mut W {
        self.bit(true)
    }
...
#[doc = r" Proxy"]
pub struct _TFTPIXEL1EMPTYW<'a> {
    w: &'a mut W,
}
impl<'a> _TFTPIXEL1EMPTYW<'a> {
    #[doc = r" Sets the field bit"]
    pub fn set_bit(self) -> &'a mut W {
        self.bit(true)
    }
...
#[doc = r" Proxy"]
pub struct _TFTPIXELFULLW<'a> {
    w: &'a mut W,
}
impl<'a> _TFTPIXELFULLW<'a> {
    #[doc = r" Sets the field bit"]
    pub fn set_bit(self) -> &'a mut W {
        self.bit(true)
    }
...
#[doc = r" Proxy"]
pub struct _TFTPIXELOFW<'a> {
    w: &'a mut W,
}
impl<'a> _TFTPIXELOFW<'a> {
    #[doc = r" Sets the field bit"]
    pub fn set_bit(self) -> &'a mut W {
        self.bit(true)
    }
...
impl W {
    ...
    #[doc = "Bit 6 - EBI_TFTPIXEL0 Empty Interrupt Enable"]
    #[inline]
    pub fn tftpixel0empty(&mut self) -> _TFTPIXEL0EMPTYW {
        _TFTPIXEL0EMPTYW { w: self }
    }
    #[doc = "Bit 7 - EBI_TFTPIXEL1 Empty Interrupt Enable"]
    #[inline]
    pub fn tftpixel1empty(&mut self) -> _TFTPIXEL1EMPTYW {
        _TFTPIXEL1EMPTYW { w: self }
    }
    #[doc = "Bit 8 - EBI_TFTPIXEL Full Interrupt Enable"]
    #[inline]
    pub fn tftpixelfull(&mut self) -> _TFTPIXELFULLW {
        _TFTPIXELFULLW { w: self }
    }
    #[doc = "Bit 9 - EBI_TFTPIXEL Overflow Interrupt Enable"]
    #[inline]
    pub fn tftpixelof(&mut self) -> _TFTPIXELOFW {
        _TFTPIXELOFW { w: self }
    }
}
