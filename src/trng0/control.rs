...
#[doc = r" Proxy"]
pub struct _CONDBYPASSW<'a> {
    w: &'a mut W,
}
impl<'a> _CONDBYPASSW<'a> {
    #[doc = r" Sets the field bit"]
    pub fn set_bit(self) -> &'a mut W {
        self.bit(true)
    }
...
#[doc = r" Proxy"]
pub struct _REPCOUNTIENW<'a> {
    w: &'a mut W,
}
impl<'a> _REPCOUNTIENW<'a> {
    #[doc = r" Sets the field bit"]
    pub fn set_bit(self) -> &'a mut W {
        self.bit(true)
    }
...
#[doc = r" Proxy"]
pub struct _APT4096IENW<'a> {
    w: &'a mut W,
}
impl<'a> _APT4096IENW<'a> {
    #[doc = r" Sets the field bit"]
    pub fn set_bit(self) -> &'a mut W {
        self.bit(true)
    }
...
impl W {
    ...
    #[doc = "Bit 3 - Conditioning Bypass"]
    #[inline]
    pub fn condbypass(&mut self) -> _CONDBYPASSW {
        _CONDBYPASSW { w: self }
    }
    #[doc = "Bit 4 - Interrupt Enable for Repetition Count Test Failure"]
    #[inline]
    pub fn repcountien(&mut self) -> _REPCOUNTIENW {
        _REPCOUNTIENW { w: self }
    }
    #[doc = "Bit 5 - Interrupt Enable for Adaptive Proportion Test Failure (64-sample Window)"]
    #[inline]
    pub fn apt64ien(&mut self) -> _APT64IENW {
        _APT64IENW { w: self }
    }
    #[doc = "Bit 6 - Interrupt Enable for Adaptive Proportion Test Failure (4096-sample Window)"]
    #[inline]
    pub fn apt4096ien(&mut self) -> _APT4096IENW {
        _APT4096IENW { w: self }
    }
    #[doc = "Bit 7 - Interrupt Enable for FIFO Full"]
    #[inline]
    pub fn fullien(&mut self) -> _FULLIENW {
        _FULLIENW { w: self }
    }
    #[doc = "Bit 8 - Software Reset"]
    #[inline]
    ...
    #[doc = "Bit 9 - Interrupt enable for AIS31 preliminary noise alarm"]
    #[inline]
    pub fn preien(&mut self) -> _PREIENW {
        _PREIENW { w: self }
    }
    #[doc = "Bit 10 - Interrupt enable for AIS31 noise alarm"]
    #[inline]
    ...
    #[doc = "Bit 11 - Oscillator Force Run"]
    #[inline]
    pub fn forcerun(&mut self) -> _FORCERUNW {
        _FORCERUNW { w: self }
    }
    #[doc = "Bit 12 - NIST Start-up Test Bypass."]
    #[inline]
    pub fn bypnist(&mut self) -> _BYPNISTW {
        _BYPNISTW { w: self }
    }
    #[doc = "Bit 13 - AIS31 Start-up Test Bypass."]
    #[inline]
    pub fn bypais31(&mut self) -> _BYPAIS31W {
        _BYPAIS31W { w: self }
    }
}
