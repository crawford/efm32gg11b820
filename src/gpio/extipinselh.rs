...
impl crate::ToBits<u8> for EXTIPINSEL8_A {
    #[inline(always)]
    fn _bits(&self) -> u8 {
        match *self {
...
impl crate::ToBits<u8> for EXTIPINSEL9_A {
    #[inline(always)]
    fn _bits(&self) -> u8 {
        match *self {
...
impl crate::ToBits<u8> for EXTIPINSEL10_A {
    #[inline(always)]
    fn _bits(&self) -> u8 {
        match *self {
...
impl crate::ToBits<u8> for EXTIPINSEL11_A {
    #[inline(always)]
    fn _bits(&self) -> u8 {
        match *self {
...
impl crate::ToBits<u8> for EXTIPINSEL12_A {
    #[inline(always)]
    fn _bits(&self) -> u8 {
        match *self {
...
impl crate::ToBits<u8> for EXTIPINSEL13_A {
    #[inline(always)]
    fn _bits(&self) -> u8 {
        match *self {
...
impl crate::ToBits<u8> for EXTIPINSEL14_A {
    #[inline(always)]
    fn _bits(&self) -> u8 {
        match *self {
...
impl crate::ToBits<u8> for EXTIPINSEL15_A {
    #[inline(always)]
    fn _bits(&self) -> u8 {
        match *self {
