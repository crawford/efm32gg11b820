...
impl R {
    ...
    #[doc = "Bit 3 - Start of (micro)Frame"]
    #[inline]
...
impl W {
    ...
    #[doc = "Bit 1 - Mode Mismatch Interrupt"]
    #[inline]
    pub fn modemis(&mut self) -> _MODEMISW {
        _MODEMISW { w: self }
    }
    #[doc = "Bit 3 - Start of (micro)Frame"]
    #[inline]
    ...
    #[doc = "Bit 10 - Early Suspend"]
    #[inline]
    pub fn erlysusp(&mut self) -> _ERLYSUSPW {
        _ERLYSUSPW { w: self }
    }
    #[doc = "Bit 11 - USB Suspend"]
    #[inline]
    ...
    #[doc = "Bit 13 - Enumeration Done"]
    #[inline]
    pub fn enumdone(&mut self) -> _ENUMDONEW {
        _ENUMDONEW { w: self }
    }
    #[doc = "Bit 14 - Isochronous OUT Packet Dropped Interrupt"]
    #[inline]
    pub fn isooutdrop(&mut self) -> _ISOOUTDROPW {
        _ISOOUTDROPW { w: self }
    }
    #[doc = "Bit 15 - End of Periodic Frame Interrupt"]
    #[inline]
    ...
    #[doc = "Bit 21 - Incomplete Periodic Transfer"]
    #[inline]
    pub fn incomplp(&mut self) -> _INCOMPLPW {
        _INCOMPLPW { w: self }
    }
    #[doc = "Bit 22 - Data Fetch Suspended"]
    #[inline]
    pub fn fetsusp(&mut self) -> _FETSUSPW {
        _FETSUSPW { w: self }
    }
    #[doc = "Bit 23 - Reset Detected Interrupt"]
    #[inline]
    pub fn resetdet(&mut self) -> _RESETDETW {
        _RESETDETW { w: self }
    }
    #[doc = "Bit 28 - Connector ID Status Change"]
    #[inline]
    pub fn conidstschng(&mut self) -> _CONIDSTSCHNGW {
        _CONIDSTSCHNGW { w: self }
    }
    #[doc = "Bit 29 - Disconnect Detected Interrupt"]
    #[inline]
    pub fn disconnint(&mut self) -> _DISCONNINTW {
        _DISCONNINTW { w: self }
    }
    #[doc = "Bit 30 - Session Request/New Session Detected Interrupt"]
    #[inline]
    pub fn sessreqint(&mut self) -> _SESSREQINTW {
        _SESSREQINTW { w: self }
    }
    #[doc = "Bit 31 - Resume/Remote Wakeup Detected Interrupt"]
    #[inline]
