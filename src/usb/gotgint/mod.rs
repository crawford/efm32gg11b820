...
impl W {
    ...
    #[doc = "Bit 2 - Session End Detected"]
    #[inline]
    pub fn sesenddet(&mut self) -> _SESENDDETW {
        _SESENDDETW { w: self }
    }
    #[doc = "Bit 8 - Session Request Success Status Change"]
    #[inline]
    pub fn sesreqsucstschng(&mut self) -> _SESREQSUCSTSCHNGW {
        _SESREQSUCSTSCHNGW { w: self }
    }
    #[doc = "Bit 9 - Host Negotiation Success Status Change"]
    #[inline]
    pub fn hstnegsucstschng(&mut self) -> _HSTNEGSUCSTSCHNGW {
        _HSTNEGSUCSTSCHNGW { w: self }
    }
    #[doc = "Bit 17 - Host Negotiation Detected"]
    #[inline]
    pub fn hstnegdet(&mut self) -> _HSTNEGDETW {
        _HSTNEGDETW { w: self }
    }
    #[doc = "Bit 18 - A-Device Timeout Change"]
    #[inline]
    pub fn adevtoutchg(&mut self) -> _ADEVTOUTCHGW {
        _ADEVTOUTCHGW { w: self }
    }
    #[doc = "Bit 19 - Debounce Done"]
    #[inline]
    pub fn dbncedone(&mut self) -> _DBNCEDONEW {
        _DBNCEDONEW { w: self }
    }
}
