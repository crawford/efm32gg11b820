...
#[doc = r" Proxy"]
pub struct _AHBTHRRATIOW<'a> {
    w: &'a mut W,
}
impl<'a> _AHBTHRRATIOW<'a> {
    #[doc = r" Writes raw bits to the field"]
    #[inline]
...
impl W {
    ...
    #[doc = "Bits 11:12 - AHB Threshold Ratio"]
    #[inline]
    pub fn ahbthrratio(&mut self) -> _AHBTHRRATIOW {
        _AHBTHRRATIOW { w: self }
    }
    #[doc = "Bit 16 - Receive Threshold Enable"]
    #[inline]
    ...
    #[doc = "Bit 27 - Arbiter Parking Enable"]
    #[inline]
    pub fn arbprken(&mut self) -> _ARBPRKENW {
        _ARBPRKENW { w: self }
    }
}
