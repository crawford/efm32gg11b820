...
impl W {
    ...
    #[doc = "Bit 0 - VBUSDETH Interrupt Enable"]
    #[inline]
    pub fn vbusdeth(&mut self) -> _VBUSDETHW {
        _VBUSDETHW { w: self }
    }
    #[doc = "Bit 1 - VBUSDETL Interrupt Enable"]
    #[inline]
    pub fn vbusdetl(&mut self) -> _VBUSDETLW {
        _VBUSDETLW { w: self }
    }
    #[doc = "Bit 8 - ERR Interrupt Enable"]
    #[inline]
