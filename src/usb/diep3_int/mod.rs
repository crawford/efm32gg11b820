...
#[doc = r" Proxy"]
pub struct _INTKNEPMISW<'a> {
    w: &'a mut W,
}
impl<'a> _INTKNEPMISW<'a> {
    #[doc = r" Sets the field bit"]
    pub fn set_bit(self) -> &'a mut W {
        self.bit(true)
    }
...
#[doc = r" Proxy"]
pub struct _TXFIFOUNDRNW<'a> {
    w: &'a mut W,
}
impl<'a> _TXFIFOUNDRNW<'a> {
    #[doc = r" Sets the field bit"]
    pub fn set_bit(self) -> &'a mut W {
        self.bit(true)
    }
...
impl W {
    ...
    #[doc = "Bit 5 - IN Token Received With EP Mismatch"]
    #[inline]
    pub fn intknepmis(&mut self) -> _INTKNEPMISW {
        _INTKNEPMISW { w: self }
    }
    #[doc = "Bit 6 - IN Endpoint NAK Effective"]
    #[inline]
    ...
    #[doc = "Bit 8 - Fifo Underrun"]
    #[inline]
    pub fn txfifoundrn(&mut self) -> _TXFIFOUNDRNW {
        _TXFIFOUNDRNW { w: self }
    }
    #[doc = "Bit 11 - Packet Drop Status"]
    #[inline]
