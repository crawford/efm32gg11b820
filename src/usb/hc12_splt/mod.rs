...
impl W {
    ...
    #[doc = "Bit 16 - Do Complete Split"]
    #[inline]
    pub fn compsplt(&mut self) -> _COMPSPLTW {
        _COMPSPLTW { w: self }
    }
    #[doc = "Bit 31 - Split Enable"]
    #[inline]
    pub fn spltena(&mut self) -> _SPLTENAW {
        _SPLTENAW { w: self }
    }
}
