...
impl W {
    ...
    #[doc = "Bit 1 - CMD I/O Enable"]
    #[inline]
    pub fn cmdpen(&mut self) -> _CMDPENW {
        _CMDPENW { w: self }
    }
    #[doc = "Bit 2 - Dat0 I/O Enable"]
    #[inline]
    pub fn d0pen(&mut self) -> _D0PENW {
        _D0PENW { w: self }
    }
    #[doc = "Bit 3 - Dat1 I/O Enable"]
    #[inline]
    pub fn d1pen(&mut self) -> _D1PENW {
        _D1PENW { w: self }
    }
    #[doc = "Bit 4 - Dat2 I/O Enable"]
    #[inline]
    pub fn d2pen(&mut self) -> _D2PENW {
        _D2PENW { w: self }
    }
    #[doc = "Bit 5 - Dat3 I/O Enable"]
    #[inline]
    pub fn d3pen(&mut self) -> _D3PENW {
        _D3PENW { w: self }
    }
    #[doc = "Bit 6 - Dat4 I/O Enable"]
    #[inline]
    pub fn d4pen(&mut self) -> _D4PENW {
        _D4PENW { w: self }
    }
    #[doc = "Bit 7 - Dat5 Enable"]
    #[inline]
    pub fn d5pen(&mut self) -> _D5PENW {
        _D5PENW { w: self }
    }
    #[doc = "Bit 8 - Dat6 Enable"]
    #[inline]
    pub fn d6pen(&mut self) -> _D6PENW {
        _D6PENW { w: self }
    }
    #[doc = "Bit 9 - Data7 I/O Enable"]
    #[inline]
    pub fn d7pen(&mut self) -> _D7PENW {
        _D7PENW { w: self }
    }
}
