...
#[doc = r" Proxy"]
pub struct _AC12INDXEW<'a> {
    w: &'a mut W,
}
impl<'a> _AC12INDXEW<'a> {
    #[doc = r" Sets the field bit"]
    pub fn set_bit(self) -> &'a mut W {
        self.bit(true)
    }
...
#[doc = r" Proxy"]
pub struct _CNIBAC12EW<'a> {
    w: &'a mut W,
}
impl<'a> _CNIBAC12EW<'a> {
    #[doc = r" Sets the field bit"]
    pub fn set_bit(self) -> &'a mut W {
        self.bit(true)
    }
...
#[doc = r" Proxy"]
pub struct _CURLIMITEW<'a> {
    w: &'a mut W,
}
impl<'a> _CURLIMITEW<'a> {
    #[doc = r" Sets the field bit"]
    pub fn set_bit(self) -> &'a mut W {
        self.bit(true)
    }
...
impl W {
    ...
    #[doc = "Bit 0 - Force Event for Command Not Issued By Auto CM12 Not Executed"]
    #[inline]
    pub fn ac12nex(&mut self) -> _AC12NEXW {
        _AC12NEXW { w: self }
    }
    #[doc = "Bit 1 - Force Event for Auto CMD Timeout Error"]
    #[inline]
    pub fn ac12toe(&mut self) -> _AC12TOEW {
        _AC12TOEW { w: self }
    }
    #[doc = "Bit 2 - Force Event for Auto CMD CRC Error"]
    #[inline]
    pub fn ac12crce(&mut self) -> _AC12CRCEW {
        _AC12CRCEW { w: self }
    }
    #[doc = "Bit 3 - Force Event for Auto CMD End Bit Error"]
    #[inline]
    pub fn ac12ebe(&mut self) -> _AC12EBEW {
        _AC12EBEW { w: self }
    }
    #[doc = "Bit 4 - Force Event for Auto CMD Index Error"]
    #[inline]
    pub fn ac12indxe(&mut self) -> _AC12INDXEW {
        _AC12INDXEW { w: self }
    }
    #[doc = "Bit 7 - Force Event for Command Not Issued By Auto CMD12 Error"]
    #[inline]
    pub fn cnibac12e(&mut self) -> _CNIBAC12EW {
        _CNIBAC12EW { w: self }
    }
    #[doc = "Bit 16 - Force Event for Command Timeout Error"]
    #[inline]
    pub fn cmdtoe(&mut self) -> _CMDTOEW {
        _CMDTOEW { w: self }
    }
    #[doc = "Bit 17 - Force Event for Command CRC Error"]
    #[inline]
    pub fn cmdcrce(&mut self) -> _CMDCRCEW {
        _CMDCRCEW { w: self }
    }
    #[doc = "Bit 18 - Force Event for Command End Bit Error"]
    #[inline]
    pub fn cmdebe(&mut self) -> _CMDEBEW {
        _CMDEBEW { w: self }
    }
    #[doc = "Bit 19 - Force Event for Command Index Error"]
    #[inline]
    pub fn cmdindxe(&mut self) -> _CMDINDXEW {
        _CMDINDXEW { w: self }
    }
    #[doc = "Bit 20 - Force Event for Data Timeout Error"]
    #[inline]
    pub fn dattoe(&mut self) -> _DATTOEW {
        _DATTOEW { w: self }
    }
    #[doc = "Bit 21 - Force Event for Data CRC Error"]
    #[inline]
    pub fn datcrce(&mut self) -> _DATCRCEW {
        _DATCRCEW { w: self }
    }
    #[doc = "Bit 22 - Force Event for Data End Bit Error"]
    #[inline]
    pub fn datebe(&mut self) -> _DATEBEW {
        _DATEBEW { w: self }
    }
    #[doc = "Bit 23 - Force Event for Current Limit Error"]
    #[inline]
    pub fn curlimite(&mut self) -> _CURLIMITEW {
        _CURLIMITEW { w: self }
    }
    #[doc = "Bit 24 - Force Event for Auto CMD Error"]
    #[inline]
