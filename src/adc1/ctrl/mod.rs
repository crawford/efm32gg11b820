...
impl CHCONREFWARMIDLER {
    ...
    pub fn bits(&self) -> u8 {
        match *self {
            CHCONREFWARMIDLER::PREFSCAN => 0,
            CHCONREFWARMIDLER::PREFSINGLE => 1,
            CHCONREFWARMIDLER::KEEPPREV => 2,
            CHCONREFWARMIDLER::_Reserved(bits) => bits,
        }
    }
    #[allow(missing_docs)]
    #[doc(hidden)]
    #[inline]
    pub fn _from(value: u8) -> CHCONREFWARMIDLER {
        match value {
            0 => CHCONREFWARMIDLER::PREFSCAN,
            1 => CHCONREFWARMIDLER::PREFSINGLE,
            2 => CHCONREFWARMIDLER::KEEPPREV,
            i => CHCONREFWARMIDLER::_Reserved(i),
        }
    }
    #[doc = "Checks if the value of the field is `PREFSCAN`"]
    #[inline]
    pub fn is_prefscan(&self) -> bool {
        *self == CHCONREFWARMIDLER::PREFSCAN
    }
    #[doc = "Checks if the value of the field is `PREFSINGLE`"]
    #[inline]
    pub fn is_prefsingle(&self) -> bool {
        *self == CHCONREFWARMIDLER::PREFSINGLE
    }
    #[doc = "Checks if the value of the field is `KEEPPREV`"]
    #[inline]
    pub fn is_keepprev(&self) -> bool {
        *self == CHCONREFWARMIDLER::KEEPPREV
    }
}
...
#[doc = "Values that can be written to the field `CHCONREFWARMIDLE`"]
pub enum CHCONREFWARMIDLEW {
    #[doc = "Keep scan reference warm and APORT switches for first scan channel closed if WARMUPMODE is not NORMAL"]
    PREFSCAN,
    #[doc = "Keep single reference warm and keep APORT switches for single channel closed if WARMUPMODE is not NORMAL"]
    PREFSINGLE,
...
impl CHCONREFWARMIDLEW {
    #[allow(missing_docs)]
    #[doc(hidden)]
    #[inline]
    pub fn _bits(&self) -> u8 {
        match *self {
            CHCONREFWARMIDLEW::PREFSCAN => 0,
            CHCONREFWARMIDLEW::PREFSINGLE => 1,
            CHCONREFWARMIDLEW::KEEPPREV => 2,
        }
    }
}
#[doc = r" Proxy"]
pub struct _CHCONREFWARMIDLEW<'a> {
    w: &'a mut W,
}
impl<'a> _CHCONREFWARMIDLEW<'a> {
    #[doc = r" Writes `variant` to the field"]
    #[inline]
    pub fn variant(self, variant: CHCONREFWARMIDLEW) -> &'a mut W {
        unsafe { self.bits(variant._bits()) }
    }
    #[doc = "Keep scan reference warm and APORT switches for first scan channel closed if WARMUPMODE is not NORMAL"]
    #[inline]
    pub fn prefscan(self) -> &'a mut W {
        self.variant(CHCONREFWARMIDLEW::PREFSCAN)
    }
    #[doc = "Keep single reference warm and keep APORT switches for single channel closed if WARMUPMODE is not NORMAL"]
    #[inline]
    pub fn prefsingle(self) -> &'a mut W {
        self.variant(CHCONREFWARMIDLEW::PREFSINGLE)
    }
    #[doc = "Keep last used reference warm and keep APORT switches for corresponding channel closed if WARMUPMODE is not NORMAL"]
    #[inline]
    pub fn keepprev(self) -> &'a mut W {
        self.variant(CHCONREFWARMIDLEW::KEEPPREV)
    }
    #[doc = r" Writes raw bits to the field"]
    #[inline]
    pub unsafe fn bits(self, value: u8) -> &'a mut W {
...
impl W {
    ...
    #[doc = "Bits 30:31 - Channel Connect and Reference Warm Sel When ADC is IDLE"]
    #[inline]
    pub fn chconrefwarmidle(&mut self) -> _CHCONREFWARMIDLEW {
        _CHCONREFWARMIDLEW { w: self }
    }
}
