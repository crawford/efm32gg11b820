...
impl W {
    ...
    #[doc = "Bits 0:7 - Address Comparator"]
    #[inline]
    pub fn adrcmp(&mut self) -> _ADRCMPW {
        _ADRCMPW { w: self }
    }
    #[doc = "Bits 8:23 - Memmap"]
    #[inline]
    pub fn memmap(&mut self) -> _MEMMAPW {
        _MEMMAPW { w: self }
    }
    #[doc = "Bit 24 - Trace Include/Exclude Flag"]
    #[inline]
    pub fn incexctl(&mut self) -> _INCEXCTLW {
        _INCEXCTLW { w: self }
    }
    #[doc = "Bit 25 - Trace Control Enable"]
    #[inline]
