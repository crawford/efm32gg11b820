...
impl VREFUPDATER {
    ...
    pub fn bits(&self) -> u8 {
        match *self {
            VREFUPDATER::_32CYCLES => 0,
            VREFUPDATER::_64CYCLES => 1,
            VREFUPDATER::_128CYCLES => 2,
            VREFUPDATER::_256CYCLES => 3,
        }
    }
    #[allow(missing_docs)]
    #[doc(hidden)]
    #[inline]
    pub fn _from(value: u8) -> VREFUPDATER {
        match value {
            0 => VREFUPDATER::_32CYCLES,
            1 => VREFUPDATER::_64CYCLES,
            2 => VREFUPDATER::_128CYCLES,
            3 => VREFUPDATER::_256CYCLES,
            _ => unreachable!(),
        }
    }
...
#[doc = "Values that can be written to the field `VREFUPDATE`"]
pub enum VREFUPDATEW {
    #[doc = "32 clocks."]
    _32CYCLES,
    #[doc = "64 clocks."]
    _64CYCLES,
...
impl VREFUPDATEW {
    ...
    pub fn _bits(&self) -> u8 {
        match *self {
            VREFUPDATEW::_32CYCLES => 0,
            VREFUPDATEW::_64CYCLES => 1,
            VREFUPDATEW::_128CYCLES => 2,
            VREFUPDATEW::_256CYCLES => 3,
        }
    }
}
#[doc = r" Proxy"]
pub struct _VREFUPDATEW<'a> {
    w: &'a mut W,
}
impl<'a> _VREFUPDATEW<'a> {
    #[doc = r" Writes `variant` to the field"]
    #[inline]
    pub fn variant(self, variant: VREFUPDATEW) -> &'a mut W {
        {
    ...
    pub fn _32cycles(self) -> &'a mut W {
        self.variant(VREFUPDATEW::_32CYCLES)
    }
    #[doc = "64 clocks."]
    #[inline]
    pub fn _64cycles(self) -> &'a mut W {
        self.variant(VREFUPDATEW::_64CYCLES)
    }
    #[doc = "128 clocks."]
    #[inline]
    pub fn _128cycles(self) -> &'a mut W {
        self.variant(VREFUPDATEW::_128CYCLES)
    }
    #[doc = "256 clocks."]
    #[inline]
    pub fn _256cycles(self) -> &'a mut W {
        self.variant(VREFUPDATEW::_256CYCLES)
    }
    #[doc = r" Writes raw bits to the field"]
    #[inline]
...
impl W {
    ...
    #[doc = "Bits 20:21 - Control Vref Update Rate"]
    #[inline]
    pub fn vrefupdate(&mut self) -> _VREFUPDATEW {
        _VREFUPDATEW { w: self }
    }
    #[doc = "Bits 24:25 - LFRCO Timeout"]
    #[inline]
