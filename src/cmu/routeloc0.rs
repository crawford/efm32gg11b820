...
impl CLKOUT2LOCR {
    ...
    pub fn bits(&self) -> u8 {
        match *self {
            ...
            CLKOUT2LOCR::LOC4 => 4,
            CLKOUT2LOCR::LOC5 => 5,
            CLKOUT2LOCR::_Reserved(bits) => bits,
        }
    }
    #[allow(missing_docs)]
    #[doc(hidden)]
    #[inline]
    pub fn _from(value: u8) -> CLKOUT2LOCR {
        match value {
            0 => CLKOUT2LOCR::LOC0,
            1 => CLKOUT2LOCR::LOC1,
            2 => CLKOUT2LOCR::LOC2,
            ...
            4 => CLKOUT2LOCR::LOC4,
            5 => CLKOUT2LOCR::LOC5,
            i => CLKOUT2LOCR::_Reserved(i),
        }
    }
    #[doc = "Checks if the value of the field is `LOC0`"]
    #[inline]
    pub fn is_loc0(&self) -> bool {
        *self == CLKOUT2LOCR::LOC0
    }
    #[doc = "Checks if the value of the field is `LOC1`"]
    #[inline]
    pub fn is_loc1(&self) -> bool {
        *self == CLKOUT2LOCR::LOC1
    }
    #[doc = "Checks if the value of the field is `LOC2`"]
    #[inline]
    pub fn is_loc2(&self) -> bool {
        *self == CLKOUT2LOCR::LOC2
    }
    #[doc = "Checks if the value of the field is `LOC3`"]
    #[inline]
    pub fn is_loc3(&self) -> bool {
        *self == CLKOUT2LOCR::LOC3
    }
    #[doc = "Checks if the value of the field is `LOC4`"]
    #[inline]
    pub fn is_loc4(&self) -> bool {
        *self == CLKOUT2LOCR::LOC4
    }
    #[doc = "Checks if the value of the field is `LOC5`"]
    #[inline]
    pub fn is_loc5(&self) -> bool {
        *self == CLKOUT2LOCR::LOC5
    }
}
...
#[doc = "Values that can be written to the field `CLKOUT2LOC`"]
pub enum CLKOUT2LOCW {
    #[doc = "Location 0"]
    LOC0,
    #[doc = "Location 1"]
    LOC1,
...
#[doc = r" Proxy"]
pub struct _CLKOUT2LOCW<'a> {
    w: &'a mut W,
}
impl<'a> _CLKOUT2LOCW<'a> {
    #[doc = r" Writes `variant` to the field"]
    #[inline]
    pub fn variant(self, variant: CLKOUT2LOCW) -> &'a mut W {
        unsafe { self.bits(variant._bits()) }
    }
    #[doc = "Location 0"]
    #[inline]
    pub fn loc0(self) -> &'a mut W {
        self.variant(CLKOUT2LOCW::LOC0)
    }
    #[doc = "Location 1"]
    #[inline]
    pub fn loc1(self) -> &'a mut W {
        self.variant(CLKOUT2LOCW::LOC1)
    }
    #[doc = "Location 2"]
    #[inline]
    pub fn loc2(self) -> &'a mut W {
        self.variant(CLKOUT2LOCW::LOC2)
    }
    #[doc = "Location 3"]
    #[inline]
    pub fn loc3(self) -> &'a mut W {
        self.variant(CLKOUT2LOCW::LOC3)
    }
    #[doc = "Location 4"]
    #[inline]
    pub fn loc4(self) -> &'a mut W {
        self.variant(CLKOUT2LOCW::LOC4)
    }
    #[doc = "Location 5"]
    #[inline]
    pub fn loc5(self) -> &'a mut W {
        self.variant(CLKOUT2LOCW::LOC5)
    }
    #[doc = r" Writes raw bits to the field"]
    #[inline]
    pub unsafe fn bits(self, value: u8) -> &'a mut W {
...
impl W {
    ...
    #[doc = "Bits 16:21 - I/O Location"]
    #[inline]
    pub fn clkout2loc(&mut self) -> _CLKOUT2LOCW {
        _CLKOUT2LOCW { w: self }
    }
}
