...
#[doc = r" Proxy"]
pub struct _CLKOUT2PENW<'a> {
    w: &'a mut W,
}
impl<'a> _CLKOUT2PENW<'a> {
    #[doc = r" Sets the field bit"]
    pub fn set_bit(self) -> &'a mut W {
        self.bit(true)
    }
...
#[doc = r" Proxy"]
pub struct _CLKIN0PENW<'a> {
    w: &'a mut W,
}
impl<'a> _CLKIN0PENW<'a> {
    #[doc = r" Sets the field bit"]
    pub fn set_bit(self) -> &'a mut W {
        self.bit(true)
    }
...
impl W {
    ...
    #[doc = "Bit 2 - CLKOUT2 Pin Enable"]
    #[inline]
    pub fn clkout2pen(&mut self) -> _CLKOUT2PENW {
        _CLKOUT2PENW { w: self }
    }
    #[doc = "Bit 28 - CLKIN0 Pin Enable"]
    #[inline]
    pub fn clkin0pen(&mut self) -> _CLKIN0PENW {
        _CLKIN0PENW { w: self }
    }
}
